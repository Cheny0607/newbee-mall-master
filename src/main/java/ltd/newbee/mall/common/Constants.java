...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "/Users/chennaiyuan/Desktop/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int GOODS_QA_SEARCH_PAGE_LIMIT = 3;
